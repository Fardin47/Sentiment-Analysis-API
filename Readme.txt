...
I have provided some extra features to the project. Such as, I have simply designed a Web page where Users can enter any text in
order to analyze the sentiment. I have called the API to perform such an operation on that web page.
...
5. Click or Open "http://127.0.0.1:8000/api/v1/analyze" to find the "Sentiment Analysis API". The api/v1 is indicating
    version 1 of this "Sentiment Analysis API". There might be a need of building some other versions of this API.
